...
namespace XUnitTests.RepositoryTests {
    public class EmployeeTest {
        readonly IEmployeeRepository _repository = new MockedEmployeeRepository();
        ...
        public void TestUpdate() {
            ...
            entity.CVUrl = "updatedCVUrl";

            _repository.Update(entity);

            Assert.Equal(entity, _repository.Get(entity.UserId));
        }
        ...
        public void TestDelete() {
            ...
            Assert.Null(_repository.Get(entity.UserId));
        }
    }
}